...
/**
 * LineProcessor main logic is to accept an s-java line and either throw an informative error of
 * returns false.
 * <p>
...
class LineProcessor {
    ...
    private boolean isVarDecLineValid(String line) throws IllegalVarDecException {
        ...
        return isVarDecLegit(line, this::createVariable);
    }
    ...
    private boolean isFuncDecValid(String line, boolean isFirstIteration) throws SyntaxException {
        ...
        String funcDecRegex = "^\\s*(void)\\s+(\\w+)\\s*\\((.*)\\)\\{\\s*$";
